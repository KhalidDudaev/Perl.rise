...
{ package rise::lib::web; use rise::core::object::namespace;   
    { package rise::lib::web::template; use rise::core::object::class;  our $AUTHORITY = "unknown"; sub AUTHORITY {"unknown"}; our $VERSION = "2016.1106144320"; sub VERSION {"2016.1106144320"}; my $__RISE_SELF__ = bless {}; sub __RISE_SELF__ ():lvalue { $__RISE_SELF__ } sub __CLASS_MEMBERS__ {q{export:simple-function-template public-var-self public-var-tname public-var-params  public-function-compile  private-function-tag  private-var-thtml  private-var-file}} 
