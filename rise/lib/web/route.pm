...
{ package rise::lib::web; use rise::core::object::namespace;   
    ...
    { package rise::lib::web::route; use rise::core::object::class;  our $AUTHORITY = "unknown"; sub AUTHORITY {"unknown"}; our $VERSION = "2016.1024131219"; sub VERSION {"2016.1024131219"}; my $__RISE_SELF__ = bless {}; sub __RISE_SELF__ ():lvalue { $__RISE_SELF__ } sub __CLASS_MEMBERS__ {q{public-function-setRoute  public-function-getRoute  public-var-routes}} 
        ...
        { package rise::lib::web::route::setRoute; use rise::core::object::function;  sub setRoute {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings; my $rmeth; no warnings; sub rmeth ():lvalue; *rmeth = sub ():lvalue { $rmeth }; use warnings; my $objref; no warnings; sub objref ():lvalue; *objref = sub ():lvalue { $objref }; use warnings;  ($self,$rmeth,$objref) = ($_[0],$_[1],$_[2]); 
