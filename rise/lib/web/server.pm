...
{ package rise::lib::web; use rise::core::object::namespace;   
    { package rise::lib::web::server; use rise::core::object::class;  our $AUTHORITY = "unknown"; sub AUTHORITY {"unknown"}; our $VERSION = "2016.1105052847"; sub VERSION {"2016.1105052847"}; my $__RISE_SELF__ = bless {}; sub __RISE_SELF__ ():lvalue { $__RISE_SELF__ } sub __CLASS_MEMBERS__ {q{public-function-app2psgi  public-function-start  public-function-start_psgi  public-function-set_header  private-var-header  private-var-html  public-var-env}} 
        ...
        { package rise::lib::web::server::app2psgi; use rise::core::object::function;  sub app2psgi {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = $_[0]; my $route; no warnings; sub route ():lvalue; *route = sub ():lvalue { $route }; use warnings;  ($route) = ($_[1]); 
            ...
            my $psgi_app; no warnings; sub psgi_app ():lvalue; *psgi_app = sub ():lvalue { $psgi_app }; use warnings;  $psgi_app = sub { return ACODE00001(__PACKAGE__, @_); { package rise::lib::web::server::app2psgi::ACODE00001; use rise::core::object::function; sub ACODE00001 { __PACKAGE__->__RISE_ERR('CODE_PRIVATE', 'ACODE00001') unless (caller eq 'rise::lib::web::server::app2psgi' || caller =~ m/^rise::lib::web::server::app2psgi\b/o); my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = $_[0]; my $env; no warnings; sub env ():lvalue; *env = sub ():lvalue { $env }; use warnings; my $args; no warnings; sub args ():lvalue; *args = sub ():lvalue { $args }; use warnings;  ($env,$args) = ($_[1],$_[2]);
