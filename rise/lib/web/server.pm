...
{ package rise::lib::web; use rise::core::object::namespace;   
    { package rise::lib::web::server; use rise::core::object::class;  our $AUTHORITY = "unknown"; sub AUTHORITY {"unknown"}; our $VERSION = "2016.1114205141"; sub VERSION {"2016.1114205141"}; my $__RISE_SELF__ = bless {}; sub __RISE_SELF__ ():lvalue { $__RISE_SELF__ } sub __class__ { $__RISE_SELF__ } sub __CLASS_MEMBERS__ {q{public-function-app2psgi  public-function-start  public-function-start_psgi  public-function-set_header  private-var-header  private-var-html  public-var-env}} 
        ...
        { package rise::lib::web::server::app2psgi; use rise::core::object::function;  sub app2psgi {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = shift; my $args; no warnings; sub args ():lvalue; *args = sub ():lvalue { $args }; use warnings;  $args = \@_; my $route; no warnings; sub route ():lvalue; *route = sub ():lvalue { $route }; use warnings;  ($route) = ($_[0]); 
            # var env = self.env;

            my $psgi_app; no warnings; sub psgi_app ():lvalue; *psgi_app = sub ():lvalue { $psgi_app }; use warnings;  $psgi_app = sub { return ACODE00001($self, @_); { package rise::lib::web::server::app2psgi::ACODE00001; use rise::core::object::function; sub ACODE00001 { __PACKAGE__->__RISE_ERR('CODE_PRIVATE', 'ACODE00001') unless (caller eq 'rise::lib::web::server::app2psgi' || caller =~ m/^rise::lib::web::server::app2psgi\b/o); my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = shift; my $args; no warnings; sub args ():lvalue; *args = sub ():lvalue { $args }; use warnings;  $args = \@_; my $env; no warnings; sub env ():lvalue; *env = sub ():lvalue { $env }; use warnings; my $args; no warnings; sub args ():lvalue; *args = sub ():lvalue { $args }; use warnings;  ($env,$args) = ($_[0],$_[1]);
        ...
        { package rise::lib::web::server::start; use rise::core::object::function;  sub start {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = shift; my $args; no warnings; sub args ():lvalue; *args = sub ():lvalue { $args }; use warnings;  $args = \@_; my $route; no warnings; sub route ():lvalue; *route = sub ():lvalue { $route }; use warnings;  ($route) = ($_[0]); 
            return $self->start_psgi($self->app2psgi($route));
        }}

        { package rise::lib::web::server::start_psgi; use rise::core::object::function;  sub start_psgi {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = shift; my $args; no warnings; sub args ():lvalue; *args = sub ():lvalue { $args }; use warnings;  $args = \@_; my $psgi_app; no warnings; sub psgi_app ():lvalue; *psgi_app = sub ():lvalue { $psgi_app }; use warnings;  ($psgi_app) = ($_[0]); 
            return Plack::Loader->auto->run($psgi_app);
        }}

        { package rise::lib::web::server::set_header; use rise::core::object::function;  sub set_header {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = shift; my $args; no warnings; sub args ():lvalue; *args = sub ():lvalue { $args }; use warnings;  $args = \@_; my $header; no warnings; sub header ():lvalue; *header = sub ():lvalue { $header }; use warnings;  ($header) = ($_[0]); 
            $self->header         = $header;
            return $self->header;
        }}
