...
{ package rise::lib::tman; use rise::core::object::namespace;   
    ...
    { package rise::lib::tman::fmm; use rise::core::object::class;  our $AUTHORITY = "unknown"; sub AUTHORITY {"unknown"}; our $VERSION = "2016.1114205141"; sub VERSION {"2016.1114205141"}; my $__RISE_SELF__ = bless {}; sub __RISE_SELF__ ():lvalue { $__RISE_SELF__ } sub __class__ { $__RISE_SELF__ } sub __CLASS_MEMBERS__ {q{public-function-monitor  private-var-fs}} 
        ...
        { package rise::lib::tman::fmm::monitor; use rise::core::object::function;  sub monitor {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = shift; my $args; no warnings; sub args ():lvalue; *args = sub ():lvalue { $args }; use warnings;  $args = \@_; my $spath; no warnings; sub spath ():lvalue; *spath = sub ():lvalue { $spath }; use warnings; my $diff; no warnings; sub diff ():lvalue; *diff = sub ():lvalue { $diff }; use warnings;  ($spath,$diff) = ($_[0],$_[1]||2); 
