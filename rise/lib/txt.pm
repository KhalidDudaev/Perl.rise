# text decoration lib
{ package rise::lib::txt; use rise::core::object::class;  our $AUTHORITY = "unknown"; sub AUTHORITY {"unknown"}; our $VERSION = "2016.1114205141"; sub VERSION {"2016.1114205141"}; my $__RISE_SELF__ = bless {}; sub __RISE_SELF__ ():lvalue { $__RISE_SELF__ } sub __class__ { $__RISE_SELF__ } sub __CLASS_MEMBERS__ {q{export:simple-function-line  export:simple-function-box}} sub __EXPORT__ { {":all"=>[qw/line box/],":function"=>[qw/line box/],":simple"=>[qw/line box/],"box"=>[qw/box/],"line"=>[qw/line/],} } 

    { package rise::lib::txt::line; use rise::core::object::function;  sub line {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = shift; my $args; no warnings; sub args ():lvalue; *args = sub ():lvalue { $args }; use warnings;  $args = \@_; my $data; no warnings; sub data ():lvalue; *data = sub ():lvalue { $data }; use warnings;  ($data) = ($_[0]); 
    ...
    { package rise::lib::txt::box; use rise::core::object::function;  sub box {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = shift; my $args; no warnings; sub args ():lvalue; *args = sub ():lvalue { $args }; use warnings;  $args = \@_; my $text; no warnings; sub text ():lvalue; *text = sub ():lvalue { $text }; use warnings; my $title; no warnings; sub title ():lvalue; *title = sub ():lvalue { $title }; use warnings; my $char; no warnings; sub char ():lvalue; *char = sub ():lvalue { $char }; use warnings;  ($text,$title,$char) = ($_[0]||'NO TEXT',$_[1]||'',$_[2]||'#'); 
