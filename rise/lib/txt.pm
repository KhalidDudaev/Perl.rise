# text decoration lib
{ package rise::lib::txt; use rise::core::object::class;  our $AUTHORITY = "unknown"; sub AUTHORITY {"unknown"}; our $VERSION = "2016.0922045452"; sub VERSION {"2016.0922045452"}; my $__CLASS_SELF__ = bless {};  sub __EXPORT__ { {":all"=>[qw/line box/],":function"=>[qw/line box/],":simple"=>[qw/line box/],"box"=>[qw/box/],"line"=>[qw/line/],} } 
