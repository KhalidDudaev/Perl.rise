...
{ package rise::lib; use rise::core::object::namespace;   
    ...
    { package rise::lib::web; use rise::core::object::class;  our $AUTHORITY = "unknown"; sub AUTHORITY {"unknown"}; our $VERSION = "2016.1016062317"; sub VERSION {"2016.1016062317"}; my $__RISE_SELF__ = bless {}; sub __RISE_SELF__ ():lvalue { $__RISE_SELF__ } sub __CLASS_MEMBERS__ {q{export:simple-function-wsay  export:simple-function-out  export:simple-function-req  export:simple-function-template  export:simple-function-_tag  export:simple-function-tsay  export:simple-function-tout  export:simple-function-query  export:simple-function-start  export:simple-function-set_header  export:simple-function-route  export:simple-function-get  export:simple-function-dmsg  private-function-__route_eq  private-var-file  private-var-data  public-var-env  private-var-out  private-var-_qobj  private-var-_tout  public-var-routes  private-var-header  private-var-html  private-var-args  private-var-apptrue}} sub __EXPORT__ { {":all"=>[qw/wsay out req template _tag tsay tout query start set_header route get dmsg/],":function"=>[qw/wsay out req template _tag tsay tout query start set_header route get dmsg/],":simple"=>[qw/wsay out req template _tag tsay tout query start set_header route get dmsg/],"_tag"=>[qw/_tag/],"dmsg"=>[qw/dmsg/],"get"=>[qw/get/],"out"=>[qw/out/],"query"=>[qw/query/],"req"=>[qw/req/],"route"=>[qw/route/],"set_header"=>[qw/set_header/],"start"=>[qw/start/],"template"=>[qw/template/],"tout"=>[qw/tout/],"tsay"=>[qw/tsay/],"wsay"=>[qw/wsay/],} } 
        ...
        { package rise::lib::web::_tag; use rise::core::object::function;  sub _tag {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings; my $str; no warnings; sub str ():lvalue; *str = sub ():lvalue { $str }; use warnings;  ($self,$str) = ($_[0],$_[1]); 
            # str =~ s{\>\s*\<}{\>\.\<}gsx;
            $str =~ s{(\<\/?\w+\>)}{\'$1\'}gsx;
            return $str;
        }}
        ...
        { package rise::lib::web::__route_eq; use rise::core::object::function; sub __route_eq { __PACKAGE__->__RISE_ERR('CODE_PRIVATE', '__route_eq') unless (caller eq 'rise::lib::web' || caller =~ m/^rise::lib::web\b/o); my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  ($self) = ($_[0]); 
            my $app; no warnings; sub app ():lvalue; *app = sub ():lvalue { $app }; use warnings;  $app = $self;
            $app->apptrue             = 0;
