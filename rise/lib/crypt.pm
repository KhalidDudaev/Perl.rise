...
{ package rise::lib; use rise::core::object::namespace;   
    { package rise::lib::crypt; use rise::core::object::class;  our $AUTHORITY = "unknown"; sub AUTHORITY {"unknown"}; our $VERSION = "2016.1105052847"; sub VERSION {"2016.1105052847"}; my $__RISE_SELF__ = bless {}; sub __RISE_SELF__ ():lvalue { $__RISE_SELF__ }  sub engname ():lvalue; no warnings; *__engname__ = sub ():lvalue {  my $self = shift; $self->{'engname'} }; *engname = sub ():lvalue {  $__RISE_SELF__->{'engname'} }; use warnings;  sub pass ():lvalue; no warnings; *__pass__ = sub ():lvalue {  my $self = shift; $self->{'pass'} }; *pass = sub ():lvalue {  $__RISE_SELF__->{'pass'} }; use warnings;  sub __CLASS_ARGS__ { (engname,pass) = ($_[1]||'AES',$_[2]||'password' ); };sub __CLASS_MEMBERS__ {q{public-function-constructor  public-function-encrypt  public-function-decrypt  public-function-set_engine  public-function-set_sha1  public-function-set_sha3  public-function-password  public-function-b64encode  public-function-b64decode  public-function-rand_pass  public-function-rand_pass2  public-function-rand_bytes  public-var-sha1  public-var-sha3  public-var-crypt_eng  public-var-passhash  public-var-key  public-var-iv   }}  
        ...
        { package rise::lib::crypt::constructor; use rise::core::object::function;  sub constructor {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = $_[0]; my $engname; no warnings; sub engname ():lvalue; *engname = sub ():lvalue { $engname }; use warnings; my $pass; no warnings; sub pass ():lvalue; *pass = sub ():lvalue { $pass }; use warnings;  ($engname,$pass) = ($_[1]||'AES',$_[2]||'password' ); 
        ...
        { package rise::lib::crypt::encrypt; use rise::core::object::function;  sub encrypt {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = $_[0]; my $data; no warnings; sub data ():lvalue; *data = sub ():lvalue { $data }; use warnings; my $pass; no warnings; sub pass ():lvalue; *pass = sub ():lvalue { $pass }; use warnings;  ($data,$pass) = ($_[1],$_[2]); 
            $self->password($pass) if $pass;
        	return $self->crypt_eng->encrypt($data, $self->key, $self->iv);
        }}

        { package rise::lib::crypt::decrypt; use rise::core::object::function;  sub decrypt {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = $_[0]; my $data; no warnings; sub data ():lvalue; *data = sub ():lvalue { $data }; use warnings; my $pass; no warnings; sub pass ():lvalue; *pass = sub ():lvalue { $pass }; use warnings;  ($data,$pass) = ($_[1],$_[2]); 
            $self->password($pass) if $pass;
        	return $self->crypt_eng->decrypt($data, $self->key, $self->iv);
        }}

        { package rise::lib::crypt::set_engine; use rise::core::object::function;  sub set_engine {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = $_[0]; my $engname; no warnings; sub engname ():lvalue; *engname = sub ():lvalue { $engname }; use warnings; my $key; no warnings; sub key ():lvalue; *key = sub ():lvalue { $key }; use warnings;  ($engname,$key) = ($_[1],$_[2]||$self->key ); 
            $self->crypt_eng         = new Crypt::Cipher:: ($engname, $key);
            return $self->crypt_eng;
        }}

        { package rise::lib::crypt::set_sha1; use rise::core::object::function;  sub set_sha1 {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = $_[0]; my $alg; no warnings; sub alg ():lvalue; *alg = sub ():lvalue { $alg }; use warnings;  ($alg) = ($_[1]||256 ); 
            $self->sha1          = new Digest::SHA:: $alg;
            return $self->sha1;
        }}

        { package rise::lib::crypt::set_sha3; use rise::core::object::function;  sub set_sha3 {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = $_[0]; my $alg; no warnings; sub alg ():lvalue; *alg = sub ():lvalue { $alg }; use warnings;  ($alg) = ($_[1]||256 ); 
            $self->sha3          = new Digest::SHA3:: $alg;
            return $self->sha3;
        }}

        { package rise::lib::crypt::password; use rise::core::object::function;  sub password {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = $_[0]; my $pass; no warnings; sub pass ():lvalue; *pass = sub ():lvalue { $pass }; use warnings;  ($pass) = ($_[1]||'password' ); 
            $self->pass              = $pass;
        ...
        { package rise::lib::crypt::b64encode; use rise::core::object::function;  sub b64encode {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = $_[0]; my $data; no warnings; sub data ():lvalue; *data = sub ():lvalue { $data }; use warnings;  ($data) = ($_[1]); 
            return MIME::Base64::encode_base64($data);
        }}

        { package rise::lib::crypt::b64decode; use rise::core::object::function;  sub b64decode {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = $_[0]; my $data; no warnings; sub data ():lvalue; *data = sub ():lvalue { $data }; use warnings;  ($data) = ($_[1]); 
            return MIME::Base64::decode_base64($data);
        }}

        { package rise::lib::crypt::rand_pass; use rise::core::object::function;  sub rand_pass {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = $_[0]; my $len; no warnings; sub len ():lvalue; *len = sub ():lvalue { $len }; use warnings;  ($len) = ($_[1]||8); 
        ...
        { package rise::lib::crypt::rand_pass2; use rise::core::object::function;  sub rand_pass2 {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = $_[0]; my $len; no warnings; sub len ():lvalue; *len = sub ():lvalue { $len }; use warnings;  ($len) = ($_[1]||8); 
        	return substr($self->sha3->add($self->rand_bytes ($len))->b64digest, 0, $len);
        }}

        { package rise::lib::crypt::rand_bytes; use rise::core::object::function;  sub rand_bytes {  my $self; no warnings; sub self ():lvalue; *self = sub ():lvalue { $self }; use warnings;  $self = $_[0]; my $len; no warnings; sub len ():lvalue; *len = sub ():lvalue { $len }; use warnings;  ($len) = ($_[1]); 
