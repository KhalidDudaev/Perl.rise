{ package rise::lib::fs; use rise::core::object::namespace;   
    { package rise::lib::fs::pathWorker; use rise::core::object::class;  
        ...
        { package rise::lib::fs::pathWorker::toAbs; use rise::core::object::funcdecl; sub  toAbs {  my $self; no warnings; local *self; sub self ():lvalue; *self = sub ():lvalue {  $self }; use warnings; my $fname; no warnings; local *fname; sub fname ():lvalue; *fname = sub ():lvalue {  $fname }; use warnings;  ($self,$fname) = ($_[0],$_[1]);
            $fname = $self->cwd . $fname if $self->isRel($fname);
            return $fname;
        }}

        { package rise::lib::fs::pathWorker::toRel; use rise::core::object::funcdecl; sub  toRel {  my $self; no warnings; local *self; sub self ():lvalue; *self = sub ():lvalue {  $self }; use warnings; my $fname; no warnings; local *fname; sub fname ():lvalue; *fname = sub ():lvalue {  $fname }; use warnings;  ($self,$fname) = ($_[0],$_[1]);
        ...
        { package rise::lib::fs::pathWorker::path; use rise::core::object::funcdecl; sub  path {  my $self; no warnings; local *self; sub self ():lvalue; *self = sub ():lvalue {  $self }; use warnings; my $fname; no warnings; local *fname; sub fname ():lvalue; *fname = sub ():lvalue {  $fname }; use warnings;  ($self,$fname) = ($_[0],$_[1]);
        ...
        { package rise::lib::fs::pathWorker::filename; use rise::core::object::funcdecl; sub  filename {  my $self; no warnings; local *self; sub self ():lvalue; *self = sub ():lvalue {  $self }; use warnings; my $fname; no warnings; local *fname; sub fname ():lvalue; *fname = sub ():lvalue {  $fname }; use warnings;  ($self,$fname) = ($_[0],$_[1]);
            $fname      =~ s{^.*?([^\\\/]*)$}{$1}sx;
            return $fname;
        }}
