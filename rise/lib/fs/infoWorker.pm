{ package rise::lib::fs; use rise::core::object::namespace;   
    { package rise::lib::fs::infoWorker; use rise::core::object::class;  our $AUTHORITY = "unknown"; sub AUTHORITY {"unknown"}; our $VERSION = "2016.1003034341"; sub VERSION {"2016.1003034341"}; my $__CLASS_SELF__ = bless {}; sub __CLASS_SELF__ ():lvalue { $__CLASS_SELF__ } sub __CLASS_MEMBERS__ {q{public-function-dev  public-function-ino  public-function-mode  public-function-nlink  public-function-uid  public-function-gid  public-function-rdev  public-function-size  public-function-atime  public-function-mtime  public-function-ctime  public-function-blksize  public-function-blocks}} 
