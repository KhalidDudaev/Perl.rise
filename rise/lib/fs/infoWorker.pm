{ package rise::lib::fs; use rise::core::object::namespace;   
    { package rise::lib::fs::infoWorker; use rise::core::object::class;  our $AUTHORITY = "unknown"; sub AUTHORITY {"unknown"}; our $VERSION = "2016.0929003752"; sub VERSION {"2016.0929003752"}; my $__CLASS_SELF__ = bless {};  
