{ package rise::lib; use rise::core::object::namespace;   
    ...
    { package rise::lib::portal;use rise::core::object::class;  __PACKAGE__->private_class("rise::lib", "rise::lib::portal");our $AUTHORITY = "unknown"; sub AUTHORITY {"unknown"}; our $VERSION = "2016.1106144320"; sub VERSION {"2016.1106144320"}; my $__RISE_SELF__ = bless {}; sub __RISE_SELF__ ():lvalue { $__RISE_SELF__ } sub __CLASS_MEMBERS__ {q{export:simple-function-portal}} sub __EXPORT__ { {":all"=>[qw/portal/],":function"=>[qw/portal/],":simple"=>[qw/portal/],"portal"=>[qw/portal/],} } 
